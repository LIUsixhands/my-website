...
<section><div class="wrap">
 ...
 <div class="cards">
  <div class="card"><h3>① 分級要看總價，不是單價</h3>
   ...
   <p>市政壹號單價在九棟中最高，但一戶只有 26 坪，典型總價 2,110 萬，是九案門檻最低的。
...
<section style="background:#faf7ef"><div class="wrap">
 ...
 <div class="tblwrap"><table style="min-width:560px">
  ...
  <tr><td><b>25–35 坪</b><span class="sub">可用約 15–22 坪</span></td><td>市政壹號廣場</td><td>九棟中唯一小坪數新案（預售）</td></tr>
  ...
  <tr><td><b>220 坪以上／整層</b><span class="sub">可用約 128 坪以上</span></td><td>聯聚中雍大廈</td><td>可兩戶合併約 448 坪，九棟中唯一</td></tr>
 </table></div>
...
<section><div class="wrap"><div class="cta">
 ...
 <p>不管你是在看、在比較，還是只是想知道手上這戶現在值多少——<br>我用實價登錄查給你看，不用先決定什麼。</p>
...
"市政壹號廣場": dict(
 ...
 cons=["單價 80.6 萬／坪為<b>全場最高</b>，每坪成本不低",
       "<b>890 戶在九棟中最多</b>，未來轉售與出租的同棟競爭最激烈",
...
"聯聚中維大廈": dict(
 ...
 who=[("上市櫃企業總部", "9,695 萬起，42 樓地標，門面需求一次到位"),
      ("要高樓視野的決策層", "九棟中樓層溢價最高的一棟，高樓層有實質稀缺性"),
...
"聯聚中雍大廈": dict(
 ...
 owner="你的優勢是<b>稀缺性</b>，不是投報率。全七期只有這一棟能給整層 224 坪與合併 448 坪，"
       "租金 1,830 元／坪也是九棟中最高。跟買方談門面與不可替代性，不要跟他比 3.26% 的投報。"),
...
"CBD時代廣場": dict(
 ...
 who=[("坪效優先的企業", "九棟中公設比 36.17% 最低，實際可用坪數最划算"),
 ...
 owner="不要跟買方談投報率，<b>那是這棟最弱的一項</b>。"
       "把主軸放在<b>公設比 36.17% 在九棟中最低</b>——同樣總價，這裡實際可用的坪數最多，"
       "這是自用買方真正在意的事。"),
...
"豐邑市政都心廣場": dict(
 ...
 who=[("收租型買方", "4.29% 是九棟最高，而且不是小贏，是大幅領先"),
      ...
      ("接受屋齡換報酬的投資方", "16 年屋齡換來的是九棟中最高的投報率")],
 buyer="這棟的<b>4.29% 毛投報率是真的，而且是九棟裡唯一超過 4% 的</b>。"
...
"NTC國家商貿中心": dict(
 ...
 who=[("30–50 人成長期企業", "73 坪、典型總價 3,654 萬，是中階最主流的配置"),
