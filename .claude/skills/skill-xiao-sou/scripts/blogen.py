...
BRAND_SHORT = "Sixhands Studio"   # title 後綴用短版，省下寬度給關鍵字
...
CTA_PRESETS = {
    "workshop": {
        ...
        "body": "4 小時實體講座，助哥在大螢幕上用 AI 實際做給你看。台北・台中・台南每月開課，每場限額 45 位。",
        "btn": "看講座場次與報名",
        "href": "../workshop.html",
    },
    "gift": {
    ...
    "courses": {
        "eyebrow": "深入學習",
        # 旗艦課是 8 週不是 12 週（courses.html 頁面與 Course schema 都是 8 週兩階段）。
        # CTA 文案跟落地頁對不上會讓人以為報錯課，也會讓結構化資料與可見內容不一致。
        "title": "8 週，把 AI 員工真正養進公司",
        "body": "第一階段打技術底座、第二階段收成數位資產，全程實作，結訓帶走能用的系統。",
        "btn": "看課程內容",
        "href": "../courses.html",
    },
}
